        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-8">
            {service.problemPoints.map((point, i) => (
              <div
                key={point.text}
                className="flex items-center gap-4 bg-white rounded-4xl p-8 h-full"
              >
                <IconIllustration
                  icon={point.icon}
                  variant="red"
                  ...
                  radius="rounded-xl"
                />
                <span className="text-gray-dark text-base sm:text-lg">
                  {point.text}
                </span>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-8">
            {service.solutionPoints.map((point, i) => (
              <div
                key={point.text}
                className="flex items-center gap-4 bg-background rounded-4xl p-8 h-full"
              >
                <IconIllustration
                  icon={point.icon}
                  variant="blue"
