        ...
        >
          <AnimatePresence>
            {hoveredIndex === item.id && (
              ...
              >
                <div className="absolute inset-x-10 -bottom-px z-30 h-px w-[20%] bg-gradient-to-r from-transparent via-primary-blue to-transparent" />
                <div className="absolute -bottom-px left-10 z-30 h-px w-[40%] bg-gradient-to-r from-transparent via-primary-blue to-transparent" />
